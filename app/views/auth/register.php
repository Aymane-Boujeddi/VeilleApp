                ...
                <form action="register" method="post" class="space-y-6">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center">
                            <input type="radio" name="role" id="freelancer" value="student" checked
                                   class="w-5 h-5 text-indigo-500 focus:ring-indigo-500">
                            <label for="freelancer" class="ml-2">Student</label>
                        </div>
                        <div class="flex items-center">
                            <input type="radio" name="role" id="client" value="teacher"
                                   class="w-5 h-5 text-indigo-500 focus:ring-indigo-500">
                            <label for="client" class="ml-2">Teacher</label>
                        </div>
                    </div>
